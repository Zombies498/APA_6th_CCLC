...
public class newspaperinformation {
			...
			public static void day() {
				System.out.println("Please enter the day e.g. 23 just purely number");
			}
			public static void article_title() {
				System.out.println("Please enter the article title (should be sentence case)");
			}
			public static void newspaper_title() {
				System.out.println("Please enter the name of the Newspapaer (should be title case)");
			}
			
			public static void page_num01() {
				System.out.println("Please enter the page range e.g. 38-45 just number plus the - between them, if don't have then press 1\n"
						+ "if it's just separate page e.g. 28, 50 or A1, A10, then press 2 to start entering");
			}
